      ...
      <div className="max-w-4xl mx-auto px-6 py-16 lg:py-24 space-y-16">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button asChild className="rounded-full justify-start bg-[#4285F4] hover:bg-[#3572E1] text-white"><a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(ADDRESS_TEXT)}`} target="_blank" rel="noopener noreferrer"><Image src="/google%20maps%20logo.png" alt="Google Maps" width={96} height={96} className="mr-2 h-10 w-10 object-contain" /> Google Maps</a></Button>
            <Button asChild className="rounded-full justify-start bg-[#33CCFF] hover:bg-[#29A3CC] text-black"><a href={`https://waze.com/ul?q=${encodeURIComponent(ADDRESS_TEXT)}`} target="_blank" rel="noopener noreferrer"><Image src="/waze%20logo.png" alt="Waze" width={96} height={96} className="mr-2 h-10 w-10 object-contain" /> Waze</a></Button>
            <Button asChild className="rounded-full justify-start bg-black hover:bg-neutral-800 text-white"><a href={`https://maps.apple.com/?q=${encodeURIComponent(ADDRESS_TEXT)}`} target="_blank" rel="noopener noreferrer"><Image src="/apple%20maps.jpeg" alt="Apple Maps" width={38} height={38} className="mr-2 h-8 w-8 object-contain" /> Apple Maps</a></Button>
