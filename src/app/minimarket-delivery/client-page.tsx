...
interface MiniMarketDeliveryClientProps {
  googleMapsApiKey: string;
}

export default function MiniMarketDeliveryClient({ googleMapsApiKey }: MiniMarketDeliveryClientProps) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 space-y-24">
        ...
        <section>
          ...
          <div className="rounded-2xl overflow-hidden shadow-soft h-96">
            <EmbeddedMap mapUrl={COLMADO_MAP_URL} mode="walking" apiKey={googleMapsApiKey} />
          </div>
        </section>
